    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div class="relative">
                ...
                <svg class="absolute left-3 top-2.5 text-slate-400 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="mb-6 flex items-center gap-3 rounded-lg bg-emerald-50 px-4 py-3 text-emerald-700 border border-emerald-200 shadow-sm animate-fade-in-down">
                        ...
                        <tr class="group hover:bg-blue-50/40 transition-colors duration-200 relative">
                            ...
                            <td class="px-6 py-4 relative">
                                ...
                                <div class="flex flex-col">
                                    <span class="font-semibold text-slate-800 {{ $request->status === 'pending' ? 'pl-2' : '' }}">
                                        {{ $request->guest_name }}
                                    </span>
                                    <span class="text-xs text-slate-500 {{ $request->status === 'pending' ? 'pl-2' : '' }}">
                                        {{ $request->guest_email }}
                                    </span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    <span class="font-medium text-slate-700">{{ $request->room->hotel->name }}</span>
            ...
            <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                ...
                <div wire:transition.scale.origin.center.duration.300ms
                    ...
                    <div class="bg-slate-50 px-6 py-4 border-b border-slate-100 flex justify-between items-center">
                        ...
                        <button wire:click="closeModal" class="text-slate-400 hover:text-slate-600 transition-colors p-1 rounded-md hover:bg-slate-200">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-2 gap-y-4 gap-x-6 mb-6">
                            <div>
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wide">Nama Tamu</p>
                            ...
                            <div class="col-span-2 bg-slate-50 p-4 rounded-xl border border-slate-100">
                                <div class="flex justify-between items-center mb-1">
                                    ...
                                    <span class="text-xs font-bold text-slate-500">
                                        {{ \Carbon\Carbon::parse($selectedRequest->check_in)->diffInDays($selectedRequest->check_out) }} Malam
                                    </span>
                                </div>
                                <p class="text-lg font-bold text-slate-900">{{ $selectedRequest->room->hotel->name }}</p>
