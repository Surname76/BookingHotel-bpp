<div>
    ...
    <div id="app-loader" wire:ignore
        ...
        <div class="text-center space-y-4 relative">
            ...
            <p class="text-sm text-slate-400 font-medium tracking-widest uppercase mt-4 animate-pulse">Memuat Pengalaman
                Terbaik...</p>
        </div>
    </div>
    ...
    <div class="bg-slate-50 min-h-screen font-sans text-slate-900">
        ...
        <div id="hotels" class="max-w-7xl mx-auto px-6 py-20">
            ...
            <div class="relative min-h-[400px]">
                ...
                {{-- Loading State --}}
                <div wire:loading
                    class="absolute inset-0 bg-slate-50/80 backdrop-blur-sm z-20 flex items-center justify-center rounded-3xl">
                    <div class="flex flex-col items-center gap-3">
                        <div class="animate-spin rounded-full h-10 w-10 border-4 border-slate-200 border-t-blue-600">
                        </div>
                        <span class="text-sm font-semibold text-slate-600 animate-pulse">Memuat data hotel...</span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @forelse($hotels as $hotel)
                        @php
                            $minPrice = $hotel->rooms->where('is_available', true)->min('price_per_night');
                        @endphp
                        <div
            ...
            window.addEventListener('load', function() {
                ...
                setTimeout(() => {
                    if (loader) {
                        ...
                        // Hapus elemen dari DOM setelah transisi
                        setTimeout(() => {
                            loader.remove();
                        }, 700);

                        // 3. Simpan flag ke sessionStorage agar tidak muncul lagi
